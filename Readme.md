...
|-----------|-------|---------|
| Text Correction | `amazon.nova-lite-v1:0` | Fix typos |
| Chat | `amazon.nova-lite-v1:0` | Intent detection, responses |
| Embeddings | `cohere.embed-english-v3` | RAG fallback |
